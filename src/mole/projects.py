...
class Project:
    ...
    def zellij_layout(self) -> str:
        ...
        command_str = f'command "{main_command[0]}"' if main_command else ""
        quoted_args = [f'"{arg}"' for arg in main_command[1:]]
        arg_str = f'args {" ".join(quoted_args)}' if quoted_args else ""
        ...
        return dedent(
            f"""\
        // auto-generated layout file using mole
